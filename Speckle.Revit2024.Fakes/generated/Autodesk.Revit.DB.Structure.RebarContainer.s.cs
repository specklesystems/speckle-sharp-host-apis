    ...
    System.Collections.Generic.IEnumerable<Autodesk.Revit.DB.Structure.RebarContainerItem>
{
  ...
  public static Autodesk.Revit.DB.Structure.RebarContainer Create(
    ...
    Autodesk.Revit.DB.ElementId rebarContainerTypeId
  ) => throw new System.NotImplementedException();

  public virtual void ClearItems() => throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.Structure.RebarContainerItem AppendItemFromRebar(
    Autodesk.Revit.DB.Structure.Rebar rebar
  ) => throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.Structure.RebarContainerItem AppendItemFromCurves(
  ...
  public virtual Autodesk.Revit.DB.Structure.RebarContainerItem AppendItemFromRebarShape(
    Autodesk.Revit.DB.Structure.RebarShape rebarShape,
    Autodesk.Revit.DB.Structure.RebarBarType barType,
    Autodesk.Revit.DB.XYZ origin,
    Autodesk.Revit.DB.XYZ xVector,
    Autodesk.Revit.DB.XYZ yVector
  ) => throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.Structure.RebarContainerItem AppendItemFromCurvesAndShape(
    Autodesk.Revit.DB.Structure.RebarShape rebarShape,
    Autodesk.Revit.DB.Structure.RebarBarType barType,
    Autodesk.Revit.DB.Structure.RebarHookType startHook,
    Autodesk.Revit.DB.Structure.RebarHookType endHook,
  ...
  public virtual void RemoveItem(Autodesk.Revit.DB.Structure.RebarContainerItem pItem) =>
    throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.Structure.RebarContainerItem GetItem(System.Int32 itemIndex) =>
    throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.Structure.RebarContainerParameterManager GetParametersManager() =>
    throw new System.NotImplementedException();
  ...
  public virtual System.Boolean IsItemHidden(Autodesk.Revit.DB.View view, System.Int32 itemIndex) =>
    throw new System.NotImplementedException();

  public virtual System.Boolean Contains(Autodesk.Revit.DB.Structure.RebarContainerItem pItem) =>
    throw new System.NotImplementedException();
  ...
  public virtual Autodesk.Revit.DB.Structure.RebarContainerIterator GetRebarContainerIterator() =>
    throw new System.NotImplementedException();

  public virtual System.Collections.Generic.IEnumerator<Autodesk.Revit.DB.Structure.RebarContainerItem> GetEnumerator() =>
    throw new System.NotImplementedException();
