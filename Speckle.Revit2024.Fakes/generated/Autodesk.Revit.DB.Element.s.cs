...
public partial class Element : System.IDisposable
{
	...
	public static Autodesk.Revit.DB.ChangeType GetChangeTypeParameter(Autodesk.Revit.DB.Parameter param) => throw new System.NotImplementedException();
	public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.Parameter> GetOrderedParameters() => throw new System.NotImplementedException();
	public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.Parameter> GetParameters(System.String name) => throw new System.NotImplementedException();
	public virtual Autodesk.Revit.DB.Parameter LookupParameter(System.String name) => throw new System.NotImplementedException();
	...
	public virtual System.Collections.Generic.ICollection<Autodesk.Revit.DB.ElementId> GetGeneratingElementIds(Autodesk.Revit.DB.GeometryObject geometryObject) => throw new System.NotImplementedException();
	public static System.Boolean CanHaveTypeAssigned(Autodesk.Revit.DB.Document document,System.Collections.Generic.ICollection<Autodesk.Revit.DB.ElementId> elementIds) => throw new System.NotImplementedException();
	public virtual System.Boolean CanHaveTypeAssigned() => throw new System.NotImplementedException();
	public static System.Boolean IsValidType(Autodesk.Revit.DB.Document document,System.Collections.Generic.ICollection<Autodesk.Revit.DB.ElementId> elementIds,Autodesk.Revit.DB.ElementId typeId) => throw new System.NotImplementedException();
	public virtual System.Boolean IsValidType(Autodesk.Revit.DB.ElementId typeId) => throw new System.NotImplementedException();
	public static System.Collections.Generic.ICollection<Autodesk.Revit.DB.ElementId> GetValidTypes(Autodesk.Revit.DB.Document document,System.Collections.Generic.ICollection<Autodesk.Revit.DB.ElementId> elementIds) => throw new System.NotImplementedException();
	public virtual System.Collections.Generic.ICollection<Autodesk.Revit.DB.ElementId> GetValidTypes() => throw new System.NotImplementedException();
	public static System.Collections.Generic.IDictionary<Autodesk.Revit.DB.ElementId, Autodesk.Revit.DB.ElementId> ChangeTypeId(Autodesk.Revit.DB.Document document,System.Collections.Generic.ICollection<Autodesk.Revit.DB.ElementId> elementIds,Autodesk.Revit.DB.ElementId typeId) => throw new System.NotImplementedException();
	...
	public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.Subelement> GetSubelements() => throw new System.NotImplementedException();
	...
	public virtual System.Boolean DeleteSubelements(System.Collections.Generic.IList<Autodesk.Revit.DB.Subelement> subelems) => throw new System.NotImplementedException();
	public virtual System.Boolean CanDeleteSubelement(Autodesk.Revit.DB.Subelement subelem) => throw new System.NotImplementedException();
	public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.ElementId> GetDependentElements(Autodesk.Revit.DB.ElementFilter filter) => throw new System.NotImplementedException();
	...
	public virtual System.Collections.Generic.IDictionary<Autodesk.Revit.DB.ExternalResourceType, Autodesk.Revit.DB.ExternalResourceReference> GetExternalResourceReferences() => throw new System.NotImplementedException();
	public virtual System.Collections.Generic.IDictionary<Autodesk.Revit.DB.ExternalResourceType, System.Collections.Generic.IList<Autodesk.Revit.DB.ExternalResourceReference>> GetExternalResourceReferencesExpanded() => throw new System.NotImplementedException();
	...
	public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.ExternalResourceReference> GetExternalResourceReferenceExpanded(Autodesk.Revit.DB.ExternalResourceType resourceType) => throw new System.NotImplementedException();
	public virtual System.Collections.Generic.ICollection<Autodesk.Revit.DB.ElementId> GetMaterialIds(System.Boolean returnPaintMaterials) => throw new System.NotImplementedException();
	public virtual System.Double GetMaterialArea(Autodesk.Revit.DB.ElementId materialId,System.Boolean usePaintMaterial) => throw new System.NotImplementedException();
	public virtual System.Double GetMaterialVolume(Autodesk.Revit.DB.ElementId materialId) => throw new System.NotImplementedException();
	public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.EvaluatedParameter> EvaluateAllParameterValues() => throw new System.NotImplementedException();
	public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.EvaluatedParameter> EvaluateParameterValues(System.Collections.Generic.ISet<Autodesk.Revit.DB.ElementId> parameterIds) => throw new System.NotImplementedException();
	...
	public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.ElementId> GetMonitoredLinkElementIds() => throw new System.NotImplementedException();
	public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.ElementId> GetMonitoredLocalElementIds() => throw new System.NotImplementedException();
	...
	public virtual System.Collections.Generic.IList<System.Guid> GetEntitySchemaGuids() => throw new System.NotImplementedException();
