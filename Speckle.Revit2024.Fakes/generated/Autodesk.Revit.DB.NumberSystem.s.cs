...
public partial class NumberSystem : Autodesk.Revit.DB.Element
{
  ...
  public static Autodesk.Revit.DB.NumberSystem Create(
    Autodesk.Revit.DB.Document document,
    Autodesk.Revit.DB.ElementId viewId,
    Autodesk.Revit.DB.LinkElementId hostElementId,
    Autodesk.Revit.DB.Architecture.StairsNumberSystemReferenceOption referenceOption,
    Autodesk.Revit.DB.LinkElementId placementLevelId
  ) => throw new System.NotImplementedException();

  public static Autodesk.Revit.DB.NumberSystem Create(
    Autodesk.Revit.DB.Document document,
    Autodesk.Revit.DB.ElementId viewId,
    Autodesk.Revit.DB.LinkElementId numberedElementId,
    Autodesk.Revit.DB.Reference referenceCurve
  ) => throw new System.NotImplementedException();
