...
public partial class ParameterUtils
{
  ...
  public static Autodesk.Revit.DB.SharedParameterElement DownloadParameter(
    Autodesk.Revit.DB.Document document,
    Autodesk.Revit.DB.ParameterDownloadOptions options,
    Autodesk.Revit.DB.ForgeTypeId parameterTypeId
  ) => throw new System.NotImplementedException();

  public static Autodesk.Revit.DB.ParameterDownloadOptions DownloadParameterOptions(
    Autodesk.Revit.DB.ForgeTypeId parameterTypeId
  ) => throw new System.NotImplementedException();

  public static System.String DownloadCompanyName(
    Autodesk.Revit.DB.Document document,
    Autodesk.Revit.DB.ForgeTypeId parameterTypeId
  ) => throw new System.NotImplementedException();
}
