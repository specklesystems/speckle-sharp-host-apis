...
public partial class CurveElement : Autodesk.Revit.DB.Element
{
  ...
  public static Autodesk.Revit.DB.CurveElement CreateAreaBasedLoadBoundaryLine(
    Autodesk.Revit.DB.Document document,
    Autodesk.Revit.DB.Curve curve,
    Autodesk.Revit.DB.ElementId levelId
  ) => throw new System.NotImplementedException();

  public static System.Collections.Generic.IList<Autodesk.Revit.DB.CurveElement> CreateAreaBasedLoadBoundaryLines(
    Autodesk.Revit.DB.Document document,
    System.Collections.Generic.IList<Autodesk.Revit.DB.Curve> curves,
    Autodesk.Revit.DB.ElementId levelId
  ) => throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.Electrical.AreaBasedLoadBoundaryLineData GetAreaBasedLoadBoundaryLineData() =>
    throw new System.NotImplementedException();
