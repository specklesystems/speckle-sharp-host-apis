...
public partial class FabricationPart : Autodesk.Revit.DB.Element
{
	...
	public virtual System.Boolean RemovePartCustomData(System.Int32 customId) => throw new System.NotImplementedException();
	public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.FabricationAncillaryUsage> GetPartAncillaryUsage() => throw new System.NotImplementedException();
	public virtual System.Boolean IsSameAs(Autodesk.Revit.DB.FabricationPart part,System.Collections.Generic.IList<Autodesk.Revit.DB.Fabrication.FabricationPartCompareType> ignoreFields) => throw new System.NotImplementedException();
	public virtual Autodesk.Revit.DB.GeometryElement GetInsulationLiningGeometry() => throw new System.NotImplementedException();
	public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.FabricationVersionInfo> GetVersionHistory() => throw new System.NotImplementedException();
	public static Autodesk.Revit.DB.FabricationPart Create(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.FabricationItemFile itemFile,Autodesk.Revit.DB.ElementId levelId) => throw new System.NotImplementedException();
	public static Autodesk.Revit.DB.FabricationPart Create(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.FabricationServiceButton button,System.Int32 condition,Autodesk.Revit.DB.ElementId levelId) => throw new System.NotImplementedException();
	public static Autodesk.Revit.DB.FabricationPart Create(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.FabricationServiceButton button,System.Double width,System.Double depth,Autodesk.Revit.DB.ElementId levelId) => throw new System.NotImplementedException();
	public static Autodesk.Revit.DB.FabricationPart CreateHanger(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.FabricationServiceButton button,System.Int32 condition,Autodesk.Revit.DB.ElementId levelId) => throw new System.NotImplementedException();
	...
	public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.FabricationDimensionDefinition> GetDimensions() => throw new System.NotImplementedException();
	public virtual System.Double GetDimensionValue(Autodesk.Revit.DB.FabricationDimensionDefinition dim) => throw new System.NotImplementedException();
	public virtual void SetDimensionValue(Autodesk.Revit.DB.FabricationDimensionDefinition dim,System.Double newValue) => throw new System.NotImplementedException();
	...
	public virtual System.Collections.Generic.IList<System.String> GetDimensionCalculatedOptions(Autodesk.Revit.DB.FabricationDimensionDefinition dim) => throw new System.NotImplementedException();
	...
	public virtual System.Boolean CanAdjustEndLength(Autodesk.Revit.DB.Connector connector) => throw new System.NotImplementedException();
	public virtual System.Double AdjustEndLength(Autodesk.Revit.DB.Connector connector,System.Double lengthToAdjust,System.Boolean totalLengthOnly) => throw new System.NotImplementedException();
	...
	public virtual System.String GetProductListEntryName(System.Int32 index) => throw new System.NotImplementedException();
	public virtual System.Int32 GetProductListEntryCount() => throw new System.NotImplementedException();
	public static System.Collections.Generic.ISet<Autodesk.Revit.DB.ElementId> OptimizeLengths(Autodesk.Revit.DB.Document document,System.Collections.Generic.ISet<Autodesk.Revit.DB.ElementId> partIds) => throw new System.NotImplementedException();
	public static void Reposition(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.ElementId partId) => throw new System.NotImplementedException();
	...
	public static System.Boolean ConnectAndCouple(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.Connector connector,Autodesk.Revit.DB.Connector toConnector) => throw new System.NotImplementedException();
	public static System.Boolean AlignPartByConnectors(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.Connector connector,Autodesk.Revit.DB.Connector toConnector,System.Double axisRotation) => throw new System.NotImplementedException();
	...
	public static void RotateConnectedTap(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.FabricationPart tap,System.Double primaryAxisRotateBy,System.Double secondaryAxisRotateBy) => throw new System.NotImplementedException();
	public static void PlaceAsTap(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.Connector tapPartConnector,Autodesk.Revit.DB.Connector hostPartConnector,System.Double distance,System.Double axisRotation,System.Double secondaryAxisRotation) => throw new System.NotImplementedException();
	public static System.Boolean PlaceFittingAsCutIn(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.ElementId straightId,Autodesk.Revit.DB.ElementId fittingId,Autodesk.Revit.DB.XYZ position,Autodesk.Revit.DB.Connector fittingConnector,System.Double axisRotation) => throw new System.NotImplementedException();
	public static void RotateConnectedPartByConnector(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.Connector connector,System.Double axisRotationBy) => throw new System.NotImplementedException();
	...
	public virtual System.String GetPartCustomDataText(System.Int32 customId) => throw new System.NotImplementedException();
	public virtual System.Int32 GetPartCustomDataInteger(System.Int32 customId) => throw new System.NotImplementedException();
	public virtual System.Double GetPartCustomDataReal(System.Int32 customId) => throw new System.NotImplementedException();
	public virtual void SetPartCustomDataText(System.Int32 customId,System.String value) => throw new System.NotImplementedException();
	public virtual void SetPartCustomDataInteger(System.Int32 customId,System.Int32 value) => throw new System.NotImplementedException();
	public virtual void SetPartCustomDataReal(System.Int32 customId,System.Double value) => throw new System.NotImplementedException();
	...
	public virtual System.Int32 MaterialGauge
	{
		get => throw new System.NotImplementedException();
	}
