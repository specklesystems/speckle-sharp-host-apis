...
{
	public AreaLoad() {}
	public static Autodesk.Revit.DB.Structure.AreaLoad Create(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.ElementId hostElemId,System.Collections.Generic.IList<Autodesk.Revit.DB.CurveLoop> loops,System.Collections.Generic.IList<Autodesk.Revit.DB.XYZ> forceVectors,System.Collections.Generic.IList<System.Int32> refPointCurveIndexes,System.Collections.Generic.IList<System.Int32> refPointCurveEnds,Autodesk.Revit.DB.Structure.AreaLoadType symbol) => throw new System.NotImplementedException();
	public static Autodesk.Revit.DB.Structure.AreaLoad Create(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.ElementId hostElemId,System.Collections.Generic.IList<Autodesk.Revit.DB.CurveLoop> loops,Autodesk.Revit.DB.XYZ forceVector,Autodesk.Revit.DB.Structure.AreaLoadType symbol) => throw new System.NotImplementedException();
	public static Autodesk.Revit.DB.Structure.AreaLoad Create(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.ElementId hostElemId,Autodesk.Revit.DB.XYZ forceVector,Autodesk.Revit.DB.Structure.AreaLoadType symbol) => throw new System.NotImplementedException();
	...
	public static System.Boolean AreCurveLoopsValid(System.Collections.Generic.IList<Autodesk.Revit.DB.CurveLoop> loops) => throw new System.NotImplementedException();
	...
	public static System.Boolean IsCurveLoopsInsideHostBoundaries(Autodesk.Revit.DB.Document doc,Autodesk.Revit.DB.ElementId hostId,System.Collections.Generic.IList<Autodesk.Revit.DB.CurveLoop> loops) => throw new System.NotImplementedException();
