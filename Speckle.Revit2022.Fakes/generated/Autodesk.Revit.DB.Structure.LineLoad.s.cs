...
{
	public LineLoad() {}
	public static Autodesk.Revit.DB.Structure.LineLoad Create(Autodesk.Revit.DB.Document aDoc,Autodesk.Revit.DB.XYZ startPoint,Autodesk.Revit.DB.XYZ endPoint,Autodesk.Revit.DB.XYZ forceVector,Autodesk.Revit.DB.XYZ momentVector,Autodesk.Revit.DB.Structure.LineLoadType symbol,Autodesk.Revit.DB.SketchPlane plane) => throw new System.NotImplementedException();
	public static Autodesk.Revit.DB.Structure.LineLoad Create(Autodesk.Revit.DB.Document aDoc,Autodesk.Revit.DB.Structure.AnalyticalModelSurface host,System.Int32 curveIndex,Autodesk.Revit.DB.XYZ forceVector1,Autodesk.Revit.DB.XYZ momentVector1,Autodesk.Revit.DB.Structure.LineLoadType symbol) => throw new System.NotImplementedException();
	public static Autodesk.Revit.DB.Structure.LineLoad Create(Autodesk.Revit.DB.Document aDoc,Autodesk.Revit.DB.Structure.AnalyticalModelStick host,Autodesk.Revit.DB.XYZ forceVector1,Autodesk.Revit.DB.XYZ momentVector1,Autodesk.Revit.DB.Structure.LineLoadType symbol) => throw new System.NotImplementedException();
