...
public partial class AnalyticalModelSurface : Autodesk.Revit.DB.Structure.AnalyticalModel
{
  ...
  public virtual System.Boolean IsValidOpeningForHide(Autodesk.Revit.DB.ElementId openingId) =>
    throw new System.NotImplementedException();

  public virtual void GetHiddenOpenings(
    out System.Collections.Generic.ICollection<Autodesk.Revit.DB.ElementId> openingsIds
  ) => throw new System.NotImplementedException();

  public virtual void GetOpenings(
    out System.Collections.Generic.ICollection<Autodesk.Revit.DB.ElementId> openingsIds
  ) => throw new System.NotImplementedException();

  public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.CurveLoop> GetOpeningLoops(
    Autodesk.Revit.DB.ElementId openingId
  ) => throw new System.NotImplementedException();

  public virtual System.Boolean HasOpenings() => throw new System.NotImplementedException();

  public virtual System.Boolean HideOpening(Autodesk.Revit.DB.ElementId openingId) =>
    throw new System.NotImplementedException();

  public virtual System.Boolean IsOpeningHidden(Autodesk.Revit.DB.ElementId openingId) =>
    throw new System.NotImplementedException();

  public virtual System.Boolean ShowOpening(Autodesk.Revit.DB.ElementId openingId) =>
    throw new System.NotImplementedException();

  public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.CurveLoop> GetLoops(
    Autodesk.Revit.DB.Structure.AnalyticalLoopType loopType
  ) => throw new System.NotImplementedException();

  public virtual System.Boolean SetLoops(
    Autodesk.Revit.DB.Structure.AnalyticalLoopType loopType,
    System.Collections.Generic.IList<Autodesk.Revit.DB.CurveLoop> newLoops
  ) => throw new System.NotImplementedException();
