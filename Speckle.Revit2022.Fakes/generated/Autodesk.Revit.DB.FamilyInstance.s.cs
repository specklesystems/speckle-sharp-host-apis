...
public partial class FamilyInstance : Autodesk.Revit.DB.Instance
{
  ...
  public virtual Autodesk.Revit.DB.Mechanical.Space get_Space(Autodesk.Revit.DB.Phase phase) =>
    throw new System.NotImplementedException();
  ...
  public virtual Autodesk.Revit.DB.Architecture.Room get_FromRoom(Autodesk.Revit.DB.Phase phase) =>
    throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.Architecture.Room get_ToRoom(Autodesk.Revit.DB.Phase phase) =>
    throw new System.NotImplementedException();

  public virtual void FlipFromToRoom() => throw new System.NotImplementedException();

  public virtual System.Collections.Generic.ICollection<Autodesk.Revit.DB.ElementId> GetSubComponentIds() =>
    throw new System.NotImplementedException();

  public virtual System.Collections.Generic.ICollection<Autodesk.Revit.DB.ElementId> GetCopingIds() =>
    throw new System.NotImplementedException();

  public virtual System.Boolean SetCopingIds(
    System.Collections.Generic.ICollection<Autodesk.Revit.DB.ElementId> cutters
  ) => throw new System.NotImplementedException();

  public virtual System.Boolean AddCoping(Autodesk.Revit.DB.FamilyInstance cutter) =>
    throw new System.NotImplementedException();

  public virtual System.Boolean RemoveCoping(Autodesk.Revit.DB.FamilyInstance cutter) =>
    throw new System.NotImplementedException();

  public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.FamilyPointPlacementReference> GetFamilyPointPlacementReferences() =>
    throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.GeometryElement GetOriginalGeometry(Autodesk.Revit.DB.Options options) =>
    throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.XYZ GetSpatialElementCalculationPoint() =>
    throw new System.NotImplementedException();

  public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.XYZ> GetSpatialElementFromToCalculationPoints() =>
    throw new System.NotImplementedException();
  ...
  public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.Reference> GetReferences(
    Autodesk.Revit.DB.FamilyInstanceReferenceType referenceType
  ) => throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.FamilyInstanceReferenceType GetReferenceType(
    Autodesk.Revit.DB.Reference reference
  ) => throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.Reference GetReferenceByName(System.String name) =>
    throw new System.NotImplementedException();

  public virtual System.String GetReferenceName(Autodesk.Revit.DB.Reference reference) =>
    throw new System.NotImplementedException();
