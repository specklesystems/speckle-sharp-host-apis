...
public partial class Material : Autodesk.Revit.DB.Element
{
  ...
  public static System.Boolean IsMaterialOrValidDefault(
    Autodesk.Revit.DB.Element pElem,
    Autodesk.Revit.DB.ElementId materialId
  ) => throw new System.NotImplementedException();

  public static System.Boolean IsNameUnique(Autodesk.Revit.DB.Document aDocument, System.String name) =>
    throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.Material Duplicate(System.String name) => throw new System.NotImplementedException();

  public virtual void SetMaterialAspectByPropertySet(
    Autodesk.Revit.DB.MaterialAspect aspect,
    Autodesk.Revit.DB.ElementId propertySetId
  ) => throw new System.NotImplementedException();

  public virtual void ClearMaterialAspect(Autodesk.Revit.DB.MaterialAspect aspect) =>
    throw new System.NotImplementedException();
