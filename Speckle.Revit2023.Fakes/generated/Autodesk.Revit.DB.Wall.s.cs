...
public partial class Wall : Autodesk.Revit.DB.HostObject
{
	...
	public virtual IList<Autodesk.Revit.DB.ElementId> GetStackedWallMemberIds() => throw new System.NotImplementedException();
	...
	public static Autodesk.Revit.DB.Wall Create(Autodesk.Revit.DB.Document document,IList<Autodesk.Revit.DB.Curve> profile,Autodesk.Revit.DB.ElementId wallTypeId,Autodesk.Revit.DB.ElementId levelId,System.Boolean structural,Autodesk.Revit.DB.XYZ normal) => throw new System.NotImplementedException();
	public static Autodesk.Revit.DB.Wall Create(Autodesk.Revit.DB.Document document,IList<Autodesk.Revit.DB.Curve> profile,Autodesk.Revit.DB.ElementId wallTypeId,Autodesk.Revit.DB.ElementId levelId,System.Boolean structural) => throw new System.NotImplementedException();
	public static Autodesk.Revit.DB.Wall Create(Autodesk.Revit.DB.Document document,IList<Autodesk.Revit.DB.Curve> profile,System.Boolean structural) => throw new System.NotImplementedException();
