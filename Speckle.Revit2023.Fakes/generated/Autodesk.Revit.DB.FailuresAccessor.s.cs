...
public partial class FailuresAccessor : System.IDisposable
{
  ...
  public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.FailureMessageAccessor> GetFailureMessages(
  ...
  public virtual System.Boolean IsFailureResolutionPermitted(
    Autodesk.Revit.DB.FailureMessageAccessor failure,
    Autodesk.Revit.DB.FailureResolutionType resolutionType
  ) => throw new System.NotImplementedException();
  ...
  public virtual Autodesk.Revit.DB.FailureHandlingOptions GetFailureHandlingOptions() =>
    throw new System.NotImplementedException();

  public virtual void SetFailureHandlingOptions(Autodesk.Revit.DB.FailureHandlingOptions options) =>
    throw new System.NotImplementedException();

  public virtual void ReplaceFailures(Autodesk.Revit.DB.FailureMessage failure) =>
    throw new System.NotImplementedException();

  public virtual void PostFailure(Autodesk.Revit.DB.FailureMessage failure) =>
    throw new System.NotImplementedException();
  ...
  public virtual void ResolveFailures(
    System.Collections.Generic.IList<Autodesk.Revit.DB.FailureMessageAccessor> failures
  ) => throw new System.NotImplementedException();

  public virtual void DeleteElements(System.Collections.Generic.IList<Autodesk.Revit.DB.ElementId> idsToDelete) =>
    throw new System.NotImplementedException();

  public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.FailureResolutionType> GetAttemptedResolutionTypes(
    Autodesk.Revit.DB.FailureMessageAccessor failure
  ) => throw new System.NotImplementedException();
  ...
  public virtual Autodesk.Revit.DB.TransactionStatus CommitPendingTransaction() =>
    throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.TransactionStatus RollBackPendingTransaction() =>
    throw new System.NotImplementedException();

  public virtual void JournalFailures(
    System.Collections.Generic.IList<Autodesk.Revit.DB.FailureMessageAccessor> failures
  ) => throw new System.NotImplementedException();
