...
public partial class Floor : Autodesk.Revit.DB.CeilingAndFloor
{
	...
	public virtual ICollection<Autodesk.Revit.DB.ElementId> GetSpanDirectionSymbolIds() => throw new System.NotImplementedException();
	public static Autodesk.Revit.DB.Floor Create(Autodesk.Revit.DB.Document document,IList<Autodesk.Revit.DB.CurveLoop> profile,Autodesk.Revit.DB.ElementId floorTypeId,Autodesk.Revit.DB.ElementId levelId) => throw new System.NotImplementedException();
	public static Autodesk.Revit.DB.Floor Create(Autodesk.Revit.DB.Document document,IList<Autodesk.Revit.DB.CurveLoop> profile,Autodesk.Revit.DB.ElementId floorTypeId,Autodesk.Revit.DB.ElementId levelId,System.Boolean isStructural,Autodesk.Revit.DB.Line slopeArrow,System.Double slope) => throw new System.NotImplementedException();
