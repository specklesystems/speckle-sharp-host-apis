...
public partial class Element : System.Object
{
	...
	public virtual IList<Autodesk.Revit.DB.Parameter> GetOrderedParameters() => throw new System.NotImplementedException();
	public virtual IList<Autodesk.Revit.DB.Parameter> GetParameters(System.String name) => throw new System.NotImplementedException();
	...
	public virtual ICollection<Autodesk.Revit.DB.ElementId> GetGeneratingElementIds(Autodesk.Revit.DB.GeometryObject geometryObject) => throw new System.NotImplementedException();
	public static System.Boolean CanHaveTypeAssigned(Autodesk.Revit.DB.Document document,ICollection<Autodesk.Revit.DB.ElementId> elementIds) => throw new System.NotImplementedException();
	public virtual System.Boolean CanHaveTypeAssigned() => throw new System.NotImplementedException();
	public static System.Boolean IsValidType(Autodesk.Revit.DB.Document document,ICollection<Autodesk.Revit.DB.ElementId> elementIds,Autodesk.Revit.DB.ElementId typeId) => throw new System.NotImplementedException();
	public virtual System.Boolean IsValidType(Autodesk.Revit.DB.ElementId typeId) => throw new System.NotImplementedException();
	public static ICollection<Autodesk.Revit.DB.ElementId> GetValidTypes(Autodesk.Revit.DB.Document document,ICollection<Autodesk.Revit.DB.ElementId> elementIds) => throw new System.NotImplementedException();
	public virtual ICollection<Autodesk.Revit.DB.ElementId> GetValidTypes() => throw new System.NotImplementedException();
	public static IDictionary<Autodesk.Revit.DB.ElementId, Autodesk.Revit.DB.ElementId> ChangeTypeId(Autodesk.Revit.DB.Document document,ICollection<Autodesk.Revit.DB.ElementId> elementIds,Autodesk.Revit.DB.ElementId typeId) => throw new System.NotImplementedException();
	...
	public virtual IList<Autodesk.Revit.DB.Subelement> GetSubelements() => throw new System.NotImplementedException();
	...
	public virtual System.Boolean DeleteSubelements(IList<Autodesk.Revit.DB.Subelement> subelems) => throw new System.NotImplementedException();
	...
	public virtual IList<Autodesk.Revit.DB.ElementId> GetDependentElements(Autodesk.Revit.DB.ElementFilter filter) => throw new System.NotImplementedException();
	...
	public virtual IDictionary<Autodesk.Revit.DB.ExternalResourceType, Autodesk.Revit.DB.ExternalResourceReference> GetExternalResourceReferences() => throw new System.NotImplementedException();
	public virtual IDictionary<Autodesk.Revit.DB.ExternalResourceType, IList<Autodesk.Revit.DB.ExternalResourceReference>> GetExternalResourceReferencesExpanded() => throw new System.NotImplementedException();
	...
	public virtual IList<Autodesk.Revit.DB.ExternalResourceReference> GetExternalResourceReferenceExpanded(Autodesk.Revit.DB.ExternalResourceType resourceType) => throw new System.NotImplementedException();
	public virtual ICollection<Autodesk.Revit.DB.ElementId> GetMaterialIds(System.Boolean returnPaintMaterials) => throw new System.NotImplementedException();
	...
	public virtual IList<Autodesk.Revit.DB.ElementId> GetMonitoredLinkElementIds() => throw new System.NotImplementedException();
	public virtual IList<Autodesk.Revit.DB.ElementId> GetMonitoredLocalElementIds() => throw new System.NotImplementedException();
