...
public partial class Rebar : Autodesk.Revit.DB.Element
{
  ...
  public static Autodesk.Revit.DB.Structure.Rebar CreateFromRebarShape(
    Autodesk.Revit.DB.Document doc,
  ...
  public static System.Boolean RebarShapeMatchesCurvesAndHooks(
    Autodesk.Revit.DB.Structure.RebarShape rebarShape,
    Autodesk.Revit.DB.Structure.RebarBarType barType,
    Autodesk.Revit.DB.XYZ norm,
    System.Collections.Generic.IList<Autodesk.Revit.DB.Curve> curves,
  ...
  public static Autodesk.Revit.DB.Structure.Rebar CreateFromCurvesAndShape(
    Autodesk.Revit.DB.Document doc,
    Autodesk.Revit.DB.Structure.RebarShape rebarShape,
    Autodesk.Revit.DB.Structure.RebarBarType barType,
    Autodesk.Revit.DB.Structure.RebarHookType startHook,
  ...
  public virtual Autodesk.Revit.DB.Structure.RebarConstraintsManager GetRebarConstraintsManager() =>
    throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.Structure.RebarRoundingManager GetReinforcementRoundingManager() =>
    throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.GeometryElement GetFullGeometryForView(Autodesk.Revit.DB.View view) =>
    throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.ElementId GetHostId() => throw new System.NotImplementedException();

  public virtual void SetHostId(Autodesk.Revit.DB.Document doc, Autodesk.Revit.DB.ElementId hostId) =>
    throw new System.NotImplementedException();
  ...
  public virtual Autodesk.Revit.DB.ElementId GetEndTreatmentTypeId(System.Int32 end) =>
    throw new System.NotImplementedException();

  public virtual void SetEndTreatmentTypeId(System.Int32 end, Autodesk.Revit.DB.ElementId endTreatmentTypeId) =>
    throw new System.NotImplementedException();
  ...
  public virtual Autodesk.Revit.DB.ParameterValue GetParameterValueAtIndex(
    Autodesk.Revit.DB.ElementId paramId,
    System.Int32 barPositionIndex
  ) => throw new System.NotImplementedException();

  public static System.Boolean ContainsValidArcRadiiForStyleAndBarType(
    System.Collections.Generic.IList<Autodesk.Revit.DB.Curve> curves,
    Autodesk.Revit.DB.Structure.RebarStyle style,
    Autodesk.Revit.DB.Structure.RebarBarType barType
  ) => throw new System.NotImplementedException();

  public virtual System.Boolean HookAngleMatchesRebarShapeDefinition(
    System.Int32 iEnd,
    Autodesk.Revit.DB.ElementId proposedHookId
  ) => throw new System.NotImplementedException();
  ...
  public virtual System.Boolean CanSuppressFirstOrLastBar(Autodesk.Revit.DB.View dBView, System.Int32 end) =>
    throw new System.NotImplementedException();
  ...
  public virtual Autodesk.Revit.DB.ElementId GetCouplerId(System.Int32 end) =>
    throw new System.NotImplementedException();
  ...
  public virtual Autodesk.Revit.DB.Structure.RebarShapeDrivenAccessor GetShapeDrivenAccessor() =>
    throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.Structure.RebarFreeFormAccessor GetFreeFormAccessor() =>
    throw new System.NotImplementedException();
