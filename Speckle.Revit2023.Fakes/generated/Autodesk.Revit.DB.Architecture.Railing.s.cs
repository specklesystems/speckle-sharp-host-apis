...
public partial class Railing : Autodesk.Revit.DB.Element
{
  ...
  public static System.Collections.Generic.ISet<Autodesk.Revit.DB.ElementId> Create(
    ...
    Autodesk.Revit.DB.ElementId railingTypeId,
    Autodesk.Revit.DB.Architecture.RailingPlacementPosition placePosition
  ) => throw new System.NotImplementedException();

  public static Autodesk.Revit.DB.Architecture.Railing Create(
    Autodesk.Revit.DB.Document document,
  ...
  public static System.Collections.Generic.ICollection<Autodesk.Revit.DB.ElementId> Create(
    Autodesk.Revit.DB.Document document,
    Autodesk.Revit.DB.ElementId stairsOrRampId,
    Autodesk.Revit.DB.ElementId railingTypeId,
    Autodesk.Revit.DB.Architecture.RailingPlacementPosition placePosition
  ) => throw new System.NotImplementedException();
  ...
  public virtual System.Boolean RailingCanBeHostedByElement(Autodesk.Revit.DB.ElementId hostId) =>
    throw new System.NotImplementedException();

  public virtual System.Collections.Generic.IList<Autodesk.Revit.DB.ElementId> GetHandRails() =>
    throw new System.NotImplementedException();
  ...
  public virtual System.Collections.Generic.ISet<Autodesk.Revit.DB.ElementId> GetMultistoryStairsPlacementLevels() =>
    throw new System.NotImplementedException();

  public virtual void SetMultistoryStairsPlacementLevels(
    System.Collections.Generic.ISet<Autodesk.Revit.DB.ElementId> levelIds
  ) => throw new System.NotImplementedException();

  public virtual Autodesk.Revit.DB.Subelement GetSubelementOnLevel(Autodesk.Revit.DB.ElementId levelId) =>
    throw new System.NotImplementedException();

  public virtual void ResetSupportPosition() => throw new System.NotImplementedException();

  public static System.Boolean IsValidHostForNewRailing(
    Autodesk.Revit.DB.Document document,
    Autodesk.Revit.DB.ElementId elementId
  ) => throw new System.NotImplementedException();

  public static System.Boolean IsValidPathForRailing(Autodesk.Revit.DB.CurveLoop curveLoop) =>
    throw new System.NotImplementedException();
