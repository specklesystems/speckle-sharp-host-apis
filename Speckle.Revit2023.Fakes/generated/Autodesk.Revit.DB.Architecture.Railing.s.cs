...
{
	public static ISet<Autodesk.Revit.DB.ElementId> Create(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.ElementId multistoryStairsId,Autodesk.Revit.DB.ElementId levelId,Autodesk.Revit.DB.ElementId railingTypeId,Autodesk.Revit.DB.Architecture.RailingPlacementPosition placePosition) => throw new System.NotImplementedException();
	...
	public static ICollection<Autodesk.Revit.DB.ElementId> Create(Autodesk.Revit.DB.Document document,Autodesk.Revit.DB.ElementId stairsOrRampId,Autodesk.Revit.DB.ElementId railingTypeId,Autodesk.Revit.DB.Architecture.RailingPlacementPosition placePosition) => throw new System.NotImplementedException();
	...
	public virtual IList<Autodesk.Revit.DB.ElementId> GetHandRails() => throw new System.NotImplementedException();
	...
	public virtual ISet<Autodesk.Revit.DB.ElementId> GetMultistoryStairsPlacementLevels() => throw new System.NotImplementedException();
	public virtual void SetMultistoryStairsPlacementLevels(ISet<Autodesk.Revit.DB.ElementId> levelIds) => throw new System.NotImplementedException();
